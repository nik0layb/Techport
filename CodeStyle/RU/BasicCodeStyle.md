...
2. 2. PSR-1. Базовый стандарт оформления кода. Основные аспекты, которые следует соблюдать.
3. 3. PSR-2. Рекомендации по оформлению кода. Хоть в названии и присутствует слово "рекомендации", фактически, так же важная часть стандарта. Так как описывает наилучше практики других программистов.
