...
```
Каждый символ "\_" («знак подчёркивания») в имени класса (Class\_Name) преобразуется в в разделитель имен каталогов. При этом названия пространств имен с этим же символом остаются не изменными.
```php
