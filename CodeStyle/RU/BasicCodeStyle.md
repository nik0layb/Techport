...
```php
    ...
    # Многое другое, что производит какие-либо действия, способные изменить и/или изменяющие, состояние приложения.
```
...
Имена __с расширением__ ".php", не вошедшие в группу выше, считаются не стандартными. 
Мною предложены следующие требования:
