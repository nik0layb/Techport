...
Кандидат №2:
- Повышение переносимости кода. Любой стандарт оформления кода на определенном языке следует тенденциям развития самого языка. Более того, общий стандарт позволяет программным путём заменить огромную часть старого кода на новый (яркий пример array() => [], которых нет в PHP7 можно было бы и вовсе не менять).
...
Большую часть статьи вы будете видеть вырезки переводов пяти официальных стандартов:
