...
* `SCREAMING\_SNAKE\_CASE` - нотация, которая определяет: каждое слово написано заглавными буквами. Все слова разделены символом нижнего подчеркивания "\_" (ASCII: 0x5F).
...
##[0] Файлы
0.1 Именование файла должно использовать 
