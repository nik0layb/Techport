...
* _МОГУТ_   содержать символы следующего класса:
```ruby
/[a-zA-Z0-9_]/
```
...
Требования:
_ДОЛЖНЫ_ транслироваться из `namespace` в путь к файлу и обратно.
_СЛЕДУЕТ_ в файлах дирректорий использовать символы из следующего класса: 
```ruby
/[a-zA-Z0-9_]/
```
