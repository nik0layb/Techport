...
###[7] Глобальные функции и методы классов

__Общее:__

До/после определения функции/метода _ДОЛЖНА_ быть одна пустая строка.

Между названием функции/метода
...
```php
	 ...
	 * Метод класса.
	 */
	public function methodName($argumentOne, $argumentTwo)
	{
	 ...
	 * Глобальная функция.
	 */
	function function_name($argument_one, $argument_two) 
	{
